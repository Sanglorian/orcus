...
∢	**Foul Belch** (react, at-will) ● **Poison**  
...
**Fallen Angel's Reckoning** (react) ● **Radiant**  
...
**Vermin Rebuke** (react, encounter) ● **Poison**  
...
†	**Snowblind Strike** (react, encounter, refreshes when first staggered)   
...
**Power System’s Repaired** (react, encounter)   
...
⋇	**Hypnotism** (standard, encounter) ● **Psychic, Charm**  
Far burst 1 within 10; +11 vs Will; 3d8+7 psychic damage and dazed (save ends).  
∢	**Spit Poison** (react, refresh 5, 6) ● **Poison**  
...
‡	**Slam** (standard, at-will)   
+8 vs AC; 1d12+4 damage.  
↗	**Ostovite Surprise** (react, at-will) ● **Acid**  
...
∢	**Umbra Burst** (react, encounter) ● **Cold, Necrotic**  
...
∢	**Shadow Burst** (react, encounter) ● **Necrotic, Healing**  
